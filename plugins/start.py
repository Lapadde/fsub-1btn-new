    ...
    if len(text)>7:
        ...
        if len(argument) == 3:
            ...
            try:
                ...
                return
        temp_msg = await message.reply("Tunggu Sebentar Tod...")
        try:
            messages = await get_messages(client, ids)
        except:
            await message.reply_text("Error Silahkan Pc @estelerkuu..!")
            return
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Join VIP ✅", callback_data = "about"),
...
WAIT_MSG = """"<b>Tunggu Sebentar Tod ...</b>"""
